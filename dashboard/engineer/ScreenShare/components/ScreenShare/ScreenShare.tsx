...
import { useScreenShareState } from '@dashboard/engineer/ScreenShare/hooks/useScreenShareState';
import { useScreenShareActions } from '@dashboard/engineer/ScreenShare/hooks/useScreenShareActions';
