...
export const handler = async (request: Request): Promise<Response> => {
  ...
  try {
    ...
    if (!signature) {
      console.error('[customer-billing-webhook] Missing Stripe-Signature header')
      return new Response(
        JSON.stringify({
    ...
    console.error('[customer-billing-webhook] Error processing webhook:', error)
...
if (import.meta.main) {
  console.info('🎣 customer-billing-webhook function starting...')
  serve(handler)
}