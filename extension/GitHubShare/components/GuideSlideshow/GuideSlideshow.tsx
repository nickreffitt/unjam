...
const GuideSlideshow: React.FC<GuideSlideshowProps> = ({ slides, platformName }) => {
  ...
  return (
    <div className="unjam-mb-4">
      <div className="unjam-flex unjam-overflow-hidden unjam-rounded-lg unjam-border unjam-border-gray-200">
        {/* Optional Image */}
        {slide.image && (
        ...
        {/* Slide Content Box */}
        <div className="unjam-flex-1 unjam-bg-gray-50 unjam-p-4">
        {/* Header */}
